...
if(isset($_POST['login'])){
    ...
    if(mysqli_num_rows($res)){
        ...
        mysqli_query($conn,"UPDATE users SET is_logged_in=1 WHERE id=".$user['id']);
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <form method="POST">
          ...
          <a href="register.php" class="d-block text-center mt-2">📝 Don't have an account?</a>
        </form>
      </div>
    </div>
  </div>
